...
class FUSD implements CryptoPlugin {
  ...
  public depositUrl(address: string, amount: string): string {
    return `zano:action=send&address=${address}&amount=${amount}&asset_id=86143388bd056a8f0bab669f78f14873fac8e2dd8d57898cdb725a2d5e2e4f8f`;
  }
